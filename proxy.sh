	#!/bin/bash
	# Please change the proxy id according to your category
  echo "Have you changed proxy_id, and edited your user_id and password in proxy.sh?"
  echo "Make sure your internet rights are active at IITD."
